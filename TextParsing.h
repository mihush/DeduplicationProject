 ...
 * @file_was_created        - pointer to bollean variable indicating that a file object was created in the hash table
 * @finished_process_blocks - pointer to bollean variable indicating we have read all the blocks of the currently
 *                            processed file object
 * @mem_pool                - pointer to memmory pool structure
...
/*
 * update_parent_dir_sn - receieves a list of descriptors of objects from current depth and previous depth
 ...
 * @input_file_index - index of the currentlly proccessedinput file in order to find the correct root object
 * @mem_pool         - pointer to memmory pool structure
 * @ht_files         - Pointer to hash table of logical file objects
